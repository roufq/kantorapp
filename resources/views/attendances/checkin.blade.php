                    ...
                    @auth
                        ...
                        @if(auth()->user()->hasRole('Admin Lokasi'))
                            <div class="alert alert-info">
                                Anda masuk sebagai <strong>Admin Lokasi</strong>{{ $effectiveName ? ' - ' . e($effectiveName) : '' }}.
                        ...
                        @elseif(auth()->user()->hasRole('Karyawan'))
                            <div class="alert alert-secondary">
                                Anda masuk sebagai <strong>Karyawan</strong>{{ $effectiveName ? ' di lokasi ' . e($effectiveName) : '' }}.
                                @if(!empty($effectiveTemporary))
                                    <br><small class="text-muted">Catatan: perubahan lokasi sementara untuk hari ini.</small>
                                @endif
                                <br>
