                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-2 mt-2">
                                <li><a class="dropdown-item py-2 px-3 rounded-3 mb-1" href="{{ route('profile.show') }}"><i class="mdi mdi-account-outline me-2"></i>Profile</a></li>
                    ...
                    <div class="top-actions">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0 border-0 dropdown-toggle hide-caret shadow-none" type="button" id="userDropdown"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ $avatarUrl }}" class="user-profile-img shadow-sm" alt="Profile" style="cursor: pointer; object-fit: cover;">
                            </button>
