  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box">
      ...
      <div class="info-box-content">
        @if($user->hasRole('Karyawan'))
          ...
          <span class="info-box-number">
            @if($todayAssignment && $todayAssignment->shift)
              ...
              @php $schedule = method_exists($todayAssignment->shift, 'getFormattedSchedule') ? $todayAssignment->shift->getFormattedSchedule() : null; @endphp
              @if($schedule && $schedule !== 'Not specified')
        ...
        @else
          <span class="info-box-text">Assignments Today</span>
          <span class="info-box-number">{{ $todayAssignmentsCount }}</span>
        @endif
      </div>
    </div>
  </div>
