      ...
      <div class="row mb-5 align-items-center">
        <div class="col-lg-7">
          <h1 class="fw-bold mb-1" style="font-size: 2.2rem; background: linear-gradient(135deg, #1e293b 0%, #334155 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            {{ __('Colleague Identity') }}
          </h1>
          <p class="text-muted mb-0" style="font-size: 1.1rem; opacity: 0.8;">{{ __('Detailed professional profile and operational assignment.') }}</p>
        </div>
        ...
        <div class="col-xl-8">
            <div class="card border-0 shadow-sm h-100 overflow-hidden">
                <div class="card-header border-bottom border-light p-4 bg-transparent d-flex align-items-center">
                    <h5 class="card-title mb-0 text-dark fw-bold"><i class="mdi mdi-card-account-details-outline text-primary me-2 fs-4"></i>{{ __('Professional Records') }}</h5>
                </div>
                <div class="card-body p-4 p-lg-5">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 bg-light h-100 transition-all border border-transparent hover-lift">
                                <label class="text-muted smallest fw-bold text-uppercase mb-2 d-block">{{ __('Direct Contact') }}</label>
                        ...
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 bg-light h-100 transition-all border border-transparent hover-lift">
                                <label class="text-muted smallest fw-bold text-uppercase mb-2 d-block">{{ __('Chronological') }}</label>
                                <div class="d-flex align-items-center mb-3">
