                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('schedule_type') is-invalid @enderror" id="schedule_type" name="schedule_type">
                                                ...
                                                <option value="daily" {{ old('schedule_type') == 'daily' ? 'selected' : '' }}>Daily Schedule</option>
                                                <option value="shifts" {{ old('schedule_type') == 'shifts' ? 'selected' : '' }}>Shift-Based Schedule</option>
                                            </select>
                                            @error('schedule_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
