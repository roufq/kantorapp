  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-lg-7">
          <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;">{{ __('Edit Location Admin') }}</h2>
          <p class="text-muted mb-0" style="font-size: 1.05rem;">{{ __('Update admin account details to ensure accurate access and responsibility.') }}</p>
        </div>
              ...
              <div class="row g-4">
                <div class="col-md-12">
                  <h5 class="text-dark fw-bold mb-3 d-flex align-items-center">
                    <i class="mdi mdi-account-edit-outline text-info me-2 fs-4"></i>{{ __('Admin Information') }}
                  </h5>
                </div>
                ...
                <div class="col-md-6">
                  <label class="form-label text-muted small fw-bold text-uppercase letter-spacing-1 mb-2">{{ __('Password (leave blank to keep)') }}</label>
                  <div class="input-group">
                    ...
                    <input type="password" name="password" class="form-control bg-dark bg-opacity-50 border-light text-white rounded-end-pill px-4 shadow-none @error('password') is-invalid @enderror">
                  </div>
