...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="{{ route('employee-contracts.create') }}" class="btn btn-primary btn-sm">Add Contract</a>
</div>
                ...
                @forelse($contracts as $contract)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('employee-contracts.destroy', $contract) }}" method="POST" style="display:inline" onsubmit="return confirm('Delete this contract?')">
                                @csrf
                                @method('DELETE')
