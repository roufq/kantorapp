...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('tasks.update', $task)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($task->photo_path): ?>
                            <div class="mt-2">
                                <small class="text-muted">Current photo: <a href="<?php echo e(route('tasks.download.photo', $task)); ?>" target="_blank">Download</a></small>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($task->document_path): ?>
                            <div class="mt-2">
                                <small class="text-muted">Current document: <a href="<?php echo e(route('tasks.download.document', $task)); ?>" target="_blank">Download</a></small>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/tasks/edit.blade.php ENDPATH**/ ?>