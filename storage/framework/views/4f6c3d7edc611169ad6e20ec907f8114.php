...
<body>
    ...
    <div>Period: <?php echo e($startDate); ?> to <?php echo e($endDate); ?></div>
    <div>Employee: <?php echo e($employeeName ?? $employeeId); ?></div>

    <table class="summary-table" style="margin-top: 8px;">
        <tr>
            <td><strong>Target (minutes)</strong>: <?php echo e($slotSummary['target_minutes'] ?? '-'); ?></td>
            <td><strong>Approved Slot (minutes)</strong>: <?php echo e($slotSummary['slot_minutes']); ?></td>
            <td><strong>Attendance (minutes)</strong>: <?php echo e($slotSummary['attendance_minutes']); ?></td>
            <td><strong>Remaining (minutes)</strong>: <?php echo e($slotSummary['remaining'] ?? '-'); ?></td>
        </tr>
    </table>
