    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="d-grid gap-2">
          ...
          <?php if($user->hasRole('Super Admin') || $user->hasRole('Admin Lokasi')): ?>
            <a class="btn btn-outline-success" href="<?php echo e(route('shift-assignments.index')); ?>">Manage Shift Assignments</a>
          <?php endif; ?>
