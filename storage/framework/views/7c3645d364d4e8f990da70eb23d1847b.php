...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('master-tasks.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="assigned_to" name="assigned_to">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('assigned_to') == $user->id ? 'selected' : ''); ?>><?php echo e($user->name); ?> (<?php echo e(ucfirst($user->role)); ?>)</option>
...
unset($__errorArgs, $__bag); ?>" id="document" name="document" accept=".pdf,.doc,.docx,.txt">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('master-tasks.index')); ?>" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views\master-tasks\create.blade.php ENDPATH**/ ?>