...
<link rel="stylesheet" href="<?php echo e(asset('NewAsset/assets/plugins/jquery-ui/jquery-ui.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('NewAsset/assets/plugins/fullcalendar/css/fullcalendar.min.css')); ?>">
<style>
  ...
  <div class="card-body">
    <form method="GET" action="<?php echo e(route('shifts.rosters.calendar')); ?>" class="row g-2 align-items-end">
      ...
      <div class="col-md-4">
        ...
        <input type="date" name="week_start" class="form-control" value="<?php echo e($focusDate->toDateString()); ?>" onchange="this.form.submit()">
      </div>
    </form>
...
<script src="<?php echo e(asset('NewAsset/assets/plugins/moment/moment.js')); ?>"></script>
<script src="<?php echo e(asset('NewAsset/assets/plugins/jquery-ui/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('NewAsset/assets/plugins/fullcalendar/js/fullcalendar.min.js')); ?>"></script>
<script>
  $(function() {
    ...
    if ($.isFunction($.fn.fullCalendar)) {
      $('#calendar').fullCalendar({
        ...
        defaultDate: '<?php echo e($focusDate->toDateString()); ?>',
        editable: false,
        eventLimit: true,
        height: 750,
