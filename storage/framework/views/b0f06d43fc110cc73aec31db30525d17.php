...
<div class="bg-light p-3 mb-3 rounded border">
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <div>
      <a href="<?php echo e(route('reports.index')); ?>" class="text-decoration-none">Kembali ke Laporan</a>
    </div>
  </div>
</div>
  ...
  <div class="card-body">
    ...
    <form method="GET" action="<?php echo e(route('reports.employee-performance')); ?>" class="row g-2 align-items-end">
      ...
      <div class="col-md-3">
        ...
        <input type="text" name="search" value="<?php echo e($search); ?>" class="form-control" placeholder="Nama karyawan">
      </div>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="text-muted small"><?php echo e($metrics['attendance_days']); ?> hari</div>
              </td>
              <td>
                <span class="fw-semibold"><?php echo e(number_format($metrics['lateness_rate'], 2)); ?>%</span>
                <div class="text-muted small"><?php echo e($metrics['late_count']); ?> dari <?php echo e($metrics['attendance_count']); ?></div>
              </td>
              <td>
                <span class="fw-semibold"><?php echo e(number_format($metrics['overtime_hours'], 2)); ?> jam</span>
              </td>
              <td>
                <?php if(is_null($metrics['min_attendance_met'])): ?>
                  <span class="text-muted">-</span>
                <?php else: ?>
                  <span class="fw-semibold"><?php echo e($metrics['attendance_minutes']); ?> / <?php echo e($metrics['min_attendance_minutes']); ?> menit</span>
                  <div class="text-muted small"><?php echo e($metrics['min_attendance_met'] ? 'Terpenuhi' : 'Belum'); ?></div>
                <?php endif; ?>
              </td>
              <td>
                <span class="fw-semibold"><?php echo e(number_format($metrics['output_efficiency_rate'], 2)); ?>%</span>
                <div class="text-muted small"><?php echo e(number_format((float) $metrics['output_points'], 2)); ?> / <?php echo e($metrics['target_points']); ?> poin</div>
              </td>
              <td>
