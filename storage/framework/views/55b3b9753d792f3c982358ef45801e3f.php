...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('jobdesk-targets.create')); ?>" class="btn btn-primary btn-sm">Tambah Target</a>
</div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $targets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($target->employee?->nama ?? 'Semua Karyawan'); ?></td>
                        ...
                        <td>
                            ...
                            <form action="<?php echo e(route('jobdesk-targets.destroy', $target)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Hapus target ini?')">
                                <?php echo csrf_field(); ?>
