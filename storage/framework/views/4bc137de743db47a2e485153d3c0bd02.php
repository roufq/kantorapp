...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-center flex-wrap gap-2">
  ...
  <a href="<?php echo e(route('shift-assignments.index')); ?>" class="text-decoration-none">Kembali ke daftar</a>
</div>

<div class="card">
  <div class="card-body">
    <form method="GET" action="<?php echo e(route('shift-assignments.calendar')); ?>" class="row g-2 align-items-end">
        ...
        <div class="col-md-4">
          ...
          <select name="location_id" class="form-control" onchange="this.form.submit()">
            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($loc->id); ?>" <?php if($loc->id == $locationId): echo 'selected'; endif; ?>><?php echo e($loc->name); ?> (<?php echo e($loc->code); ?>)</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/shift-assignments/calendar.blade.php ENDPATH**/ ?>