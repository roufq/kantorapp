...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-secondary btn-sm">Kembali</a>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php ($roles = $user->getRoleNames()); ?>
                <?php if($roles->contains('Admin Lokasi')): ?>
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('users.promote.hr', $user)); ?>" method="POST" onsubmit="return confirm('Promote this user to HR? This will remove Admin Lokasi/Karyawan roles.')">
                        <?php echo csrf_field(); ?>
