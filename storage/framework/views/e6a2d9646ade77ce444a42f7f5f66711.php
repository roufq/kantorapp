  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-lg-7">
          <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;"><?php echo e(__('Assign Location Shifts')); ?></h2>
          <p class="text-muted mb-0" style="font-size: 1.05rem;"><?php echo e(__('Create custom shift configurations for the selected location.')); ?></p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="card shadow-sm border-0 p-4 rounded-4 border border-light shadow-sm mb-4">
                    <label for="location_id" class="form-label text-muted small fw-bold text-uppercase letter-spacing-1 mb-3"><?php echo e(__('Select Location *')); ?></label>
                    <select class="form-select bg-dark bg-opacity-50 border-light text-white rounded-pill px-4 shadow-none <?php $__errorArgs = ['location_id'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="invalid-feedback ms-3"><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0" style="border-radius: 24px !important;">
                    <div class="card-header border-bottom border-light p-4" style="background: #f8fafc;">
                        <h5 class="card-title mb-0 text-dark fw-bold"><i class="mdi mdi-clock-check-outline me-2 text-info"></i><?php echo e(__('Select Shifts *')); ?></h5>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer border-top border-light p-4 bg-transparent d-flex justify-content-end gap-3">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-lg">
                            <i class="mdi mdi-content-save-check-outline me-2"></i><?php echo e(__('Assign Shifts')); ?>
