      ...
      <div class="modal-body p-4">
        <div class="d-flex flex-column gap-3">
            <div class="p-3 bg-light rounded-4 border border-light">
                <div class="smaller text-muted fw-bold text-uppercase mb-1"><?php echo e(__('Active Timeline')); ?></div>
            ...
            <div class="row g-3">
                <div class="col-6">
                    <div class="p-3 bg-light rounded-4 border border-light h-100">
                        <div class="smaller text-muted fw-bold text-uppercase mb-1"><?php echo e(__('Operation')); ?></div>
                        <div id="modal-shift-name" class="fw-bold text-dark">Office Shift</div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 bg-light rounded-4 border border-light h-100">
                        <div class="smaller text-muted fw-bold text-uppercase mb-1"><?php echo e(__('Status')); ?></div>
            ...
            <div id="modal-notes-container" class="p-3 bg-light rounded-4 border border-light">
                <div class="smaller text-muted fw-bold text-uppercase mb-1"><?php echo e(__('System Notes')); ?></div>
