    ...
    <div id="wrapper">
        ...
        <div class="side-menu">
            ...
            <ul class="menu-list">
                ...
                <li>
                    <a href="<?php echo e(route('messages.index')); ?>" class="<?php echo e(request()->routeIs('messages.*') ? 'active' : ''); ?>">
                ...
                ?>
                <li>
                    <a href="<?php echo e(route('tasks.progress.approvals')); ?>" class="<?php echo e(request()->routeIs('tasks.progress.approvals') ? 'active' : ''); ?>">
                        <i class="mdi mdi-shield-check-outline"></i> 
                        <span><?php echo e(__('Task Approvals')); ?> <?php if($pendingCreationCount>0): ?><span class="badge rounded-pill bg-warning text-dark ms-2"><?php echo e($pendingCreationCount); ?></span><?php endif; ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('shifts.rosters.calendar')); ?>" class="<?php echo e(request()->routeIs('shifts.rosters.calendar') ? 'active' : ''); ?>">
                ...
                <?php if($authUser->hasAnyRole(['Super Admin', 'Location Admin', 'Employee'])): ?>
                <li>
                    <a href="<?php echo e(route('location-change-requests.index')); ?>" class="<?php echo e(request()->routeIs('location-change-requests.*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('attendance.checkin')); ?>" class="<?php echo e(request()->routeIs('attendance.checkin') ? 'active' : ''); ?>">
                        <i class="mdi mdi-clock-check-outline"></i> <span><?php echo e(__('Check In/Out')); ?></span>
                    </a>
                </li>
                <?php if($authUser->hasAnyRole(['Super Admin', 'Location Admin'])): ?>
                <li>
                    <a href="<?php echo e(route('attendance.report')); ?>" class="<?php echo e(request()->routeIs('attendance.report') ? 'active' : ''); ?>">
                        <i class="mdi mdi-calendar-search"></i> <span><?php echo e(__('Attendance Report')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('attendance.absences')); ?>" class="<?php echo e(request()->routeIs('attendance.absences') ? 'active' : ''); ?>">
                        <i class="mdi mdi-account-alert-outline"></i> <span><?php echo e(__('Absences')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('attendance.recap')); ?>" class="<?php echo e(request()->routeIs('attendance.recap') ? 'active' : ''); ?>">
                ...
                <?php if($authUser->hasAnyRole(['Super Admin', 'Location Admin', 'Employee'])): ?>
                <li>
                    <a href="<?php echo e(route('overtime.index')); ?>" class="<?php echo e(request()->routeIs('overtime.*') ? 'active' : ''); ?>">
                ...
                <?php if($authUser->hasAnyRole(['Super Admin', 'Location Admin'])): ?>
                <li>
                    <a href="<?php echo e(route('work-recaps.index')); ?>" class="<?php echo e(request()->routeIs('work-recaps.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-timer-sand"></i> <span><?php echo e(__('Working Hours Recap')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('work-targets.index')); ?>" class="<?php echo e(request()->routeIs('work-targets.*') ? 'active' : ''); ?>">
                ...
                ?>
                <li>
                    <a href="<?php echo e(route('holidays.index')); ?>" class="<?php echo e(request()->routeIs('holidays.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-calendar-star-outline"></i> 
                        <span><?php echo e(__('Holidays')); ?> <?php if($upcomingHolidayCount>0): ?><span class="badge rounded-pill bg-info text-dark ms-2"><?php echo e($upcomingHolidayCount); ?></span><?php endif; ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('weekly-offs.index')); ?>" class="<?php echo e(request()->routeIs('weekly-offs.*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('leaves.index')); ?>" class="<?php echo e(request()->routeIs('leaves.*') ? 'active' : ''); ?>">
                        ...
                        <span><?php echo e(__('Leaves')); ?> <?php if($pendingLeavesCount>0 && ($authUser->hasRole('Super Admin') || $authUser->hasRole('Location Admin'))): ?><span class="badge rounded-pill bg-warning text-dark ms-2"><?php echo e($pendingLeavesCount); ?></span><?php endif; ?></span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li>
                    <a href="<?php echo e(route('location-admin-tasks.index')); ?>" class="<?php echo e(request()->routeIs('location-admin-tasks.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-map-marker-radius"></i> <span><?php echo e(__('Location Tasks')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('shifts.rosters.index')); ?>" class="<?php echo e(request()->routeIs('shifts.rosters.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-calendar-clock-outline"></i> <span><?php echo e(__('Weekly Rosters')); ?></span>
                    </a>
                </li>
                <?php if($authUser->location_id): ?>
                <li>
                    <a href="<?php echo e(route('locations.settings', $authUser->location_id)); ?>" class="<?php echo e(request()->routeIs('locations.settings*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-office-building-cog-outline"></i> <span><?php echo e(__('My Location Settings')); ?></span>
                    </a>
                </li>
                <?php endif; ?>
                <?php endif; ?>
                ...
                <li>
                    <a href="<?php echo e(route('jobdesks.index')); ?>" class="<?php echo e(request()->routeIs('jobdesks.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-briefcase-variant-outline"></i> <span><?php echo e(__('Jobdesk & Catalog')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('jobdesk-targets.index')); ?>" class="<?php echo e(request()->routeIs('jobdesk-targets.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-bullseye-arrow"></i> <span><?php echo e(__('Target Output')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('approval-rules.index')); ?>" class="<?php echo e(request()->routeIs('approval-rules.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-playlist-check"></i> <span><?php echo e(__('Approval Rules')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('employee-positions.index')); ?>" class="<?php echo e(request()->routeIs('employee-positions.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-account-tie-outline"></i> <span><?php echo e(__('Position History')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('employee-transfers.index')); ?>" class="<?php echo e(request()->routeIs('employee-transfers.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-account-switch-outline"></i> <span><?php echo e(__('Transfers')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('employee-contracts.index')); ?>" class="<?php echo e(request()->routeIs('employee-contracts.*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('divisions.index')); ?>" class="<?php echo e(request()->routeIs('divisions.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-layers-triple-outline"></i> <span><?php echo e(__('Divisions')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('locations.index')); ?>" class="<?php echo e(request()->routeIs('locations.index') || request()->routeIs('locations.show') || request()->routeIs('locations.edit') ? 'active' : ''); ?>">
                        <i class="mdi mdi-map-search-outline"></i> <span><?php echo e(__('All Locations')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('location-shifts.index')); ?>" class="<?php echo e(request()->routeIs('location-shifts.*') ? 'active' : ''); ?>">
                        <i class="mdi mdi-clock-fast"></i> <span><?php echo e(__('Location Shifts')); ?></span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('location-admins.index')); ?>" class="<?php echo e(request()->routeIs('location-admins.*') ? 'active' : ''); ?>">
            ...
            <div class="mobile-header">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo e(route('profile.show')); ?>">
                        <img src="<?php echo e($authUser->profile_photo_path ? asset('storage/' . $authUser->profile_photo_path) : asset('assets/img/user2-160x160.jpg')); ?>" class="rounded-pill" style="width: 32px; height: 32px;" alt="">
                    </a>
                </div>
            </div>
