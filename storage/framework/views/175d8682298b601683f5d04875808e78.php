...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
  ...
  <a href="<?php echo e(route('locations.show', $location)); ?>" class="btn btn-outline-secondary btn-sm">Kembali</a>
</div>
<div class="row">
  <div class="col-12">
    <style>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo e(route('locations.update', $location)); ?>">
          <?php echo csrf_field(); ?>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="mb-3">
                ...
                <input type="number" step="any" class="form-control" id="loc_latitude" name="latitude" value="<?php echo e(old('latitude', $location->latitude)); ?>" placeholder="-6.2">
              </div>
            </div>
            <div class="col-md-4">
              <div class="mb-3">
                <label class="form-label">Longitude</label>
                <input type="number" step="any" class="form-control" id="loc_longitude" name="longitude" value="<?php echo e(old('longitude', $location->longitude)); ?>" placeholder="106.8">
              </div>
            </div>
            <div class="col-md-4">
              <div class="mb-3">
                <label class="form-label">Radius (meter)</label>
                <input type="number" class="form-control" id="loc_radius" name="radius" value="<?php echo e(old('radius', $location->radius ?? 50)); ?>" placeholder="50">
          ...
          <div class="form-check mb-3">
            <input class="form-check-input" type="checkbox" value="1" id="is_default" name="is_default" <?php if($location->is_default): ?> checked <?php endif; ?>>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="brand_name" value="<?php echo e(old('brand_name', $location->brand_name)); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Brand Logo URL/Path</label>
                <input type="text" class="form-control" name="brand_logo_url" value="<?php echo e(old('brand_logo_url', $location->brand_logo_url)); ?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="primary_color" value="<?php echo e(old('primary_color', $location->primary_color)); ?>" placeholder="#0d6efd">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Secondary Color</label>
                <input type="text" class="form-control" name="secondary_color" value="<?php echo e(old('secondary_color', $location->secondary_color)); ?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="custom_css_url" value="<?php echo e(old('custom_css_url', $location->custom_css_url)); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Custom JS URL</label>
                <input type="text" class="form-control" name="custom_js_url" value="<?php echo e(old('custom_js_url', $location->custom_js_url)); ?>">
              </div>
            </div>
          </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo e(route('locations.settings.update', $location)); ?>">
          <?php echo csrf_field(); ?>
          <?php echo method_field('PATCH'); ?>
          <div class="row g-3">
            <div class="col-md-6">
              <label class="form-label">Approval Pending (Harian)</label>
              <input type="time" class="form-control" name="settings[0][value]" value="<?php echo e(old('notify_pending_approvals_time', $notificationSettings['notify_pending_approvals_time'] ?? '00:00')); ?>" required>
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control" name="settings[1][value]" value="<?php echo e(old('notify_shift_h1_time', $notificationSettings['notify_shift_h1_time'] ?? '00:00')); ?>" required>
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control" name="settings[2][value]" value="<?php echo e(old('notify_leave_monthly_summary_time', $notificationSettings['notify_leave_monthly_summary_time'] ?? '00:00')); ?>" required>
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control" name="settings[3][value]" value="<?php echo e(old('notify_leave_monthly_reminder_time', $notificationSettings['notify_leave_monthly_reminder_time'] ?? '00:00')); ?>" required>
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Location Settings - <?php echo e($location->name); ?></h3>
      </div>
      <div class="card-body">
        <form method="POST" action="<?php echo e(route('locations.settings.update', $location)); ?>">
          <?php echo csrf_field(); ?>
          ...
          <div class="table-responsive">
            <table class="table" id="settings-table">
              ...
              <tbody>
                <?php $__currentLoopData = $location->locationSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td class="row-no"><?php echo e($loop->iteration); ?></td>
                  <td><input type="text" name="settings[<?php echo e($idx); ?>][key]" value="<?php echo e($setting->key); ?>" class="form-control" required></td>
                  <td><input type="text" name="settings[<?php echo e($idx); ?>][value]" value='<?php echo e(is_string($setting->value) ? $setting->value : json_encode($setting->value)); ?>' class="form-control" required></td>
                  <td>
                    <select name="settings[<?php echo e($idx); ?>][type]" class="form-control" required>
                      <?php $__currentLoopData = ['string','number','boolean','json']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($type); ?>" <?php if($setting->type === $type): ?> selected <?php endif; ?>><?php echo e($type); ?></option>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/locations/settings.blade.php ENDPATH**/ ?>