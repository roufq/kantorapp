  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-lg-7">
          <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;"><?php echo e(__('Add Work Hours Target')); ?></h2>
          <p class="text-muted mb-0" style="font-size: 1.05rem;"><?php echo e(__('Define working minutes target per location (optional per employee) for a specific month.')); ?></p>
        </div>
      ...
      <div class="row">
        <div class="col-xxl-8 col-xl-10 mx-auto">
          <div class="card shadow-sm border-0 p-4 p-md-5 rounded-4 border border-light shadow-lg">
            <form action="<?php echo e(route('work-targets.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row g-4">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6 mt-5">
                        ...
                        <div class="input-group text-white">
                            ...
                            <input type="number" min="0" name="target_minutes" class="form-control bg-dark bg-opacity-50 border-light text-white rounded-end-pill px-4 shadow-none font-monospace" value="<?php echo e(old('target_minutes', 0)); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5 d-flex justify-content-end gap-3">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 py-2 fw-bold shadow-lg">
                            <i class="mdi mdi-content-save-outline me-2"></i><?php echo e(__('Save')); ?>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views\work-targets\create.blade.php ENDPATH**/ ?>