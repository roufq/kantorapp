...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    <div>
        <h3 class="mb-1">Jobdesk Detail</h3>
...
<div class="card mb-3">
    <div class="card-body">
        <p><strong>Name:</strong> <?php echo e($jobdesk->name); ?></p>
        <p><strong>Description:</strong> <?php echo e($jobdesk->description ?? '-'); ?></p>
        <p><strong>Role Scope:</strong> <?php echo e($jobdesk->role_scope ?? '-'); ?></p>
        <p><strong>Location:</strong> <?php echo e($jobdesk->location?->name ?? $jobdesk->location?->nama ?? 'Global'); ?></p>
        <p><strong>Status:</strong> <?php echo e($jobdesk->is_active ? 'Active' : 'Inactive'); ?></p>
        <p><strong>Minimum Attendance (minutes):</strong> <?php echo e($jobdesk->min_attendance_minutes ?? '-'); ?></p>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('jobdesks.catalogs.index', $jobdesk)); ?>" class="btn btn-sm btn-outline-primary">Manage Catalog</a>
        </div>
    </div>
    <div class="card-body">
        <?php if($jobdesk->taskCatalogs->isEmpty()): ?>
            <div class="text-muted">No task catalogs yet.</div>
        <?php else: ?>
            <ul class="mb-0">
