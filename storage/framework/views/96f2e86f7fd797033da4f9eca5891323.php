...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('jobdesks.catalogs.create', $jobdesk)); ?>" class="btn btn-primary btn-sm">Tambah Task</a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?php echo e($catalog->is_active ? 'badge-success' : 'badge-secondary'); ?>">
                                <?php echo e($catalog->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                        </td>
                        <td>
                            <a href="<?php echo e(route('jobdesks.catalogs.edit', [$jobdesk, $catalog])); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                            <form action="<?php echo e(route('jobdesks.catalogs.destroy', [$jobdesk, $catalog])); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Hapus task catalog ini?')">
                                <?php echo csrf_field(); ?>
