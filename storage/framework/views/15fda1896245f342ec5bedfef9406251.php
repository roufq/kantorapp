...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('master-tasks.create')); ?>" class="btn btn-primary btn-sm">Assign Task</a>
</div>

<!-- Search Form -->
<div class="mb-4">
    <form method="GET" action="<?php echo e(route('master-tasks.employee-tasks.index')); ?>" class="d-flex">
        ...
        <?php if(request('search')): ?>
            <a href="<?php echo e(route('master-tasks.employee-tasks.index')); ?>" class="btn btn-outline-secondary ms-2">Clear</a>
        <?php endif; ?>
    </form>
</div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Assigned to:</strong> <?php echo e($task->assignee->name); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views\master-tasks\employee-tasks\index.blade.php ENDPATH**/ ?>