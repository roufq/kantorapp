...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <?php if(auth()->user()->hasRole('Super Admin')): ?>
            <a href="<?php echo e(route('overtime.report')); ?>" class="btn btn-info me-2">View Report</a>
        <?php endif; ?>
        <?php if(auth()->user()->hasRole('Karyawan')): ?>
            <a href="<?php echo e(route('overtime.create')); ?>" class="btn btn-primary">Request Overtime</a>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/overtime/index.blade.php ENDPATH**/ ?>