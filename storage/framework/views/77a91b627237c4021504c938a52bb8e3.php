  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-lg-7">
          <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;"><?php echo e(__('Add Location Admin')); ?></h2>
          <p class="text-muted mb-0" style="font-size: 1.05rem;"><?php echo e(__('Establish admin accounts to manage operations at specific locations.')); ?></p>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8">
          <div class="card shadow-sm border-0 p-4 p-md-5 rounded-4 border border-light shadow-lg">
            <form action="<?php echo e(route('location-admins.store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <div class="row g-4">
                <div class="col-md-12">
                  <h5 class="text-dark fw-bold mb-3 d-flex align-items-center">
                    <i class="mdi mdi-account-details-outline text-info me-2 fs-4"></i><?php echo e(__('Admin Information')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                  <label class="form-label text-muted small fw-bold text-uppercase letter-spacing-1 mb-2"><?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>" required>
                    <option value="" disabled selected><?php echo e(__('-- Select Location --')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-12 mt-5 text-end">
                  ...
                  <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-lg">
                    <i class="mdi mdi-check-circle-outline me-2"></i><?php echo e(__('Create')); ?>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views\location-admins\create.blade.php ENDPATH**/ ?>