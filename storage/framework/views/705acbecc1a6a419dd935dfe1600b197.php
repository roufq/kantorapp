...
<div class="bg-light p-3 mb-3 rounded border">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
        ...
        <div>
            <a href="<?php echo e(route('location-change-requests.index')); ?>" class="btn btn-outline-secondary waves-effect waves-light">Back</a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="col-12 d-flex flex-wrap align-items-center gap-2 mt-2">
            ...
            <a href="<?php echo e(route('location-change-requests.index')); ?>" class="btn btn-outline-secondary waves-effect">Cancel</a>
        </div>
        </form>
    </div>
</div>
