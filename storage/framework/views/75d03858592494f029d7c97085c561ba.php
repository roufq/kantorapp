...
<div class="bg-light p-3 mb-3 rounded border">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
        ...
        <div>
            <a href="<?php echo e(route('location-change-requests.index')); ?>" class="btn btn-outline-secondary waves-effect waves-light">Kembali</a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('location-change-requests.store')); ?>" method="POST" class="row g-3">
        <?php echo csrf_field(); ?>
        <?php if(isset($users) && $users): ?>
        <div class="col-md-6">
            <label for="user_id" class="form-label">Employee</label>
            <div class="searchable-dropdown position-relative" data-placeholder="-- Pilih user --">
                <input type="hidden" name="user_id" id="user_id" value="<?php echo e(old('user_id', '')); ?>" required>
                ...
                <div class="searchable-panel card shadow-sm p-2 d-none" style="position:absolute; z-index:1000; width:100%; left:0; top:100%; border:1px solid #dee2e6;">
                    ...
                    <div class="list-group searchable-list" style="max-height:220px; overflow:auto;">
                        ...
                        <button type="button" class="list-group-item list-group-item-action searchable-option" data-value="<?php echo e(auth()->id()); ?>" data-label="— Assign to Myself (<?php echo e(auth()->user()->name); ?>) —">— Assign to Myself (<?php echo e(auth()->user()->name); ?>) —</button>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="list-group-item list-group-item-action searchable-option" data-value="<?php echo e($u->id); ?>" data-label="<?php echo e($u->name); ?> @ <?php echo e($u->email); ?> (<?php echo e($u->location->name ?? 'No Location'); ?>)"><?php echo e($u->name); ?> @ <?php echo e($u->email); ?> (<?php echo e($u->location->name ?? 'No Location'); ?>)</button>
        ...
        <div class="col-md-6">
            ...
            <div class="searchable-dropdown position-relative" data-placeholder="-- Pilih lokasi --">
                <input type="hidden" name="target_location_id" id="target_location_id" value="<?php echo e(old('target_location_id', $locations->first()->id ?? '')); ?>" required>
                ...
                <div class="searchable-panel card shadow-sm p-2 d-none" style="position:absolute; z-index:1000; width:100%; left:0; top:100%; border:1px solid #dee2e6;">
                    ...
                    <div class="list-group searchable-list" style="max-height:220px; overflow:auto;">
                        ...
                        <button type="button" class="list-group-item list-group-item-action searchable-option" data-value="<?php echo e($location->id); ?>" data-label="<?php echo e($location->name); ?>"><?php echo e($location->name); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            ...
            <textarea name="reason" id="reason" class="form-control" rows="3" required><?php echo e(old('reason')); ?></textarea>
        </div>
        <div class="col-12">
            <div class="row g-2 align-items-center">
                <div class="col-lg-4 col-md-6">
                    <label for="request_date" class="form-label">Effective Date</label>
                    <input type="date" class="form-control" id="request_date" name="request_date" value="<?php echo e(old('request_date', now()->toDateString())); ?>" required>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="form-check mb-1">
                        <input type="checkbox" class="form-check-input" id="is_permanent" name="is_permanent" value="1" <?php echo e(old('is_permanent') ? 'checked' : ''); ?>>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="form-check mb-1">
                        <input type="checkbox" class="form-check-input" id="approve_now" name="approve_now" value="1" <?php echo e(old('approve_now') ? 'checked' : ''); ?>>
        ...
        <div class="col-12 d-flex flex-wrap align-items-center gap-2 mt-2">
            ...
            <a href="<?php echo e(route('location-change-requests.index')); ?>" class="btn btn-outline-secondary waves-effect">Batal</a>
        </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/location_change_requests/create.blade.php ENDPATH**/ ?>