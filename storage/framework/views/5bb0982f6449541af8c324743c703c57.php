    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('jobdesks.store')); ?>" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="role_scope" class="form-control" value="<?php echo e(old('role_scope')); ?>" placeholder="Example: Employee, Location Admin">
            </div>
            <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="min_attendance_minutes" class="form-control" min="0" value="<?php echo e(old('min_attendance_minutes')); ?>" placeholder="Example: 360 for 6 hours">
            </div>
            ...
            <div class="col-12">
                ...
                <a href="<?php echo e(route('jobdesks.index')); ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
