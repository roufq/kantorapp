      ...
      <div class="sidebar-wrapper">
        <nav class="mt-2">
          ...
          <ul
            ...
            <?php endif; ?>
            <?php endif; ?>
            <?php if(auth()->user()->hasAnyRole(['Super Admin','HR'])): ?>
            <li class="nav-header">HR</li>
            <li class="nav-item">
                <a href="<?php echo e(route('jobdesks.index')); ?>" class="nav-link <?php echo e(request()->routeIs('jobdesks.*') ? 'active' : ''); ?>">
                    <i class="nav-icon fas fa-briefcase"></i>
                    <p>Jobdesk & Catalog</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('jobdesk-targets.index')); ?>" class="nav-link <?php echo e(request()->routeIs('jobdesk-targets.*') ? 'active' : ''); ?>">
                    <i class="nav-icon fas fa-bullseye"></i>
                    <p>Target Output</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('approval-rules.index')); ?>" class="nav-link <?php echo e(request()->routeIs('approval-rules.*') ? 'active' : ''); ?>">
                    <i class="nav-icon fas fa-clipboard-check"></i>
                    <p>Approval Rules</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('employee-positions.index')); ?>" class="nav-link <?php echo e(request()->routeIs('employee-positions.*') ? 'active' : ''); ?>">
                    <i class="nav-icon fas fa-id-badge"></i>
                    <p>Histori Jabatan</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('employee-transfers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('employee-transfers.*') ? 'active' : ''); ?>">
                    <i class="nav-icon fas fa-exchange-alt"></i>
                    <p>Mutasi</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('employee-contracts.index')); ?>" class="nav-link <?php echo e(request()->routeIs('employee-contracts.*') ? 'active' : ''); ?>">
