...
<div class="bg-light p-3 mb-3 rounded border">
    <h1 class="h4 mb-1">Tambah Target Jam Kerja</h1>
    <p class="text-muted mb-0">Tetapkan menit kerja per lokasi (opsional per karyawan) untuk bulan tertentu.</p>
</div>

<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('work-targets.store')); ?>" method="POST" class="row g-3">
            <?php echo csrf_field(); ?>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" min="0" name="target_minutes" class="form-control" value="<?php echo e(old('target_minutes', 0)); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/work-targets/create.blade.php ENDPATH**/ ?>