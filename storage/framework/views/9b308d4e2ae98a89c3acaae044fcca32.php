          ...
          <form method="GET">
              <div class="row g-3">
                  <div class="col-xl-2 col-md-4">
                      ...
                      <input type="date" name="start_date" class="form-control bg-dark bg-opacity-50 border-light text-white rounded-pill px-4 shadow-none" value="<?php echo e(request('start_date', $start)); ?>">
                  </div>
                  <div class="col-xl-2 col-md-4">
                      <label class="form-label text-muted small fw-bold text-uppercase letter-spacing-1 mb-2"><?php echo e(__('End Date')); ?></label>
                      <input type="date" name="end_date" class="form-control bg-dark bg-opacity-50 border-light text-white rounded-pill px-4 shadow-none" value="<?php echo e(request('end_date', $end)); ?>">
                  </div>
                  ...
                  <div class="col-xl-4 col-md-8 d-flex align-items-end gap-2">
                      ...
                      <a href="<?php echo e(route('attendance.recap')); ?>" class="btn btn-outline-secondary rounded-circle p-2 d-flex align-items-center justify-content-center shadow-sm" style="width: 42px; height: 42px;">
