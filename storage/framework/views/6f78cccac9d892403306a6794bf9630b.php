...
<div class="row mb-4 align-items-center">
    <div class="col-lg-7">
        <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;"><?php echo e(__('Task Detail')); ?></h2>
        <p class="text-muted mb-0" style="font-size: 1.05rem;"><?php echo e($task->title); ?></p>
    </div>
    <div class="col-lg-5 text-lg-end mt-3 mt-lg-0">
        <a href="<?php echo e(route('tasks.index')); ?>" class="btn btn-outline-light text-dark border bg-white rounded-pill px-4 fw-bold shadow-sm">
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-light mb-4" id="taskDetailCard">
            <div class="card-header border-bottom border-light p-4 d-flex justify-content-between align-items-center" style="background: #ffffff;">
                <h5 class="card-title mb-0 text-dark fw-bold"><?php echo e($task->title); ?></h5>
                <span class="badge <?php echo e($task->status === 'completed' ? 'badge-success' : ($task->status === 'in_progress' ? 'badge-info' : 'badge-secondary')); ?>">
            ...
            <div class="card-body p-4">
                <div class="mb-4">
                    <label class="text-muted smaller fw-bold mb-2 text-uppercase letter-spacing-1"><?php echo e(__('Description')); ?></label>
                    <div class="p-3 bg-light rounded-4 border border-light" style="background-color: #fcfdfe !important;">
                        <p class="text-dark mb-0" style="line-height: 1.7; font-size: 0.95rem; opacity: 0.9;"><?php echo e($task->description); ?></p>
                    </div>
                </div>
                ...
                <div class="row mb-4 g-3">
                    <div class="col-md-6">
                        <div class="p-3 rounded-4 border border-light h-100" style="background: #ffffff;">
                            <div class="text-muted smaller fw-bold text-uppercase mb-3"><?php echo e(__('Approval Status')); ?></div>
                            <?php if($task->requires_approval): ?>
                                <?php if($task->approval_status === 'approved'): ?>
                                    ...
                                    <div class="smaller text-muted ms-5"><?php echo e(optional($task->approved_at)->format('d M Y H:i')); ?></div>
                                <?php elseif($task->approval_status === 'pending'): ?>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="text-dark fw-bold small">Waiting for <?php echo e($task->approval_level === 'location_admin' ? 'Location Admin' : 'Super Admin'); ?></span>
                                    </div>
                                <?php else: ?>
                                    <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 rounded-4 border border-light h-100" style="background: #ffffff;">
                            <div class="d-flex justify-content-between text-muted smaller fw-bold text-uppercase mb-3">
                                <span><?php echo e(__('Task Progress')); ?></span>
                                <span class="text-dark fw-bold"><?php echo e($task->progress ?? 0); ?>%</span>
                            </div>
                            <div class="progress rounded-pill shadow-none mb-2" style="height:10px; background: #f1f5f9;">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($task->progress ?? 0); ?>%; background-color: #10b981;"></div>
                            </div>
                ...
                <div class="row g-3">
                    <div class="col-sm-6 col-md-3">
                        <div class="text-muted smaller fw-bold text-uppercase mb-1"><?php echo e(__('Assigned By')); ?></div>
                        <div class="text-dark fw-bold small"><?php echo e($task->assigner->name); ?></div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="text-muted smaller fw-bold text-uppercase mb-1"><?php echo e(__('Assigned To')); ?></div>
                        <div class="text-primary fw-bold small"><?php echo e(optional($task->assignee)->name ?? 'N/A'); ?></div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="text-muted smaller fw-bold text-uppercase mb-1"><?php echo e(__('Target Date')); ?></div>
                        <div class="text-dark small fw-bold">
                            <span class="text-<?php echo e($task->due_date && $task->due_date->isPast() ? 'danger' : 'dark'); ?>">
                                <?php echo e($task->due_date ? $task->due_date->format('d M Y') : 'No Due Date'); ?>

                            </span>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="text-muted smaller fw-bold text-uppercase mb-1"><?php echo e(__('Est. Duration')); ?></div>
                        <div class="text-dark small fw-bold"><?php echo e($task->duration_minutes ? $task->duration_minutes . ' mins' : '-'); ?></div>
                    </div>
                </div>
            </div>
            <div class="card-footer border-top border-light p-4 d-flex justify-content-between align-items-center" style="background: #ffffff;">
                <div>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $task)): ?>
                        <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="btn btn-sm btn-outline-info rounded-pill px-3 fw-bold">
                            <i class="mdi mdi-pencil-outline me-1"></i><?php echo e(__('Edit Task')); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <?php if($canUpdateProgress): ?>
                        <a href="<?php echo e(route('tasks.progress.create', $task)); ?>" class="btn btn-primary rounded-pill px-4 fw-bold shadow-soft">
                            <i class="mdi mdi-update me-1"></i><?php echo e(__('Update Progress')); ?>

                        </a>
                    <?php elseif(!$hasSlots): ?>
                        <span class="badge badge-warning"><i class="mdi mdi-alert-circle-outline me-1"></i> <?php echo e(__('Needs Slots')); ?></span>
                    <?php elseif($task->requires_approval && $task->approval_status !== 'approved'): ?>
                         <span class="badge <?php echo e($task->approval_status === 'rejected' ? 'badge-danger' : 'badge-warning'); ?>">
                            <i class="mdi mdi-timer-sand me-1"></i> <?php echo e($task->approval_status === 'rejected' ? 'Rejected' : 'Awaiting Approval'); ?>
        ...
        <div class="card shadow-sm border-light">
            <div class="card-header border-bottom border-light p-4" style="background: #ffffff;">
                <h5 class="mb-0 text-dark fw-bold"><i class="mdi mdi-view-list-outline me-2 text-info"></i><?php echo e(__('Progress Slots')); ?></h5>
            </div>
            <div class="card-body p-4">
                <?php
                ...
                <?php if($slotIncomplete): ?>
                    <div class="alert badge-warning bg-opacity-10 border-0 p-3 mb-4 rounded-4 d-flex align-items-center">
                        ...
                        <span class="fw-bold fw-bold smaller" style="text-transform: none; letter-spacing: 0;">
                            <?php echo e(__('Slot composition is missing')); ?> <?php echo e($missingPercent); ?>% <?php echo e($missingMinutes ? 'and ' . $missingMinutes . ' mins.' : '.'); ?>

                        </span>
                    </div>
                <?php endif; ?>

                <?php if(auth()->user()->hasAnyRole(['Super Admin','Location Admin'])): ?>
                    <div class="mb-4">
                        <button class="btn btn-light border bg-white rounded-pill px-4 fw-bold shadow-sm w-100 mb-2 py-2" type="button" id="addSlotToggleBtn" data-bs-toggle="collapse" data-bs-target="#addSlotFormSide" <?php if(!$slotIncomplete): ?> disabled <?php endif; ?>>
                            <i class="mdi mdi-plus-circle-outline me-1"></i><?php echo e(__('Create Progress Slot')); ?>
                        ...
                        <div class="collapse" id="addSlotFormSide">
                            <div class="card shadow-sm border-light p-4 rounded-4 mt-3">
                                ...
                                <form action="<?php echo e(route('tasks.slots.store', $task)); ?>" method="POST" class="row g-3" id="addSlotFormSideForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-md-6">
                                        <label class="form-label text-muted smaller fw-bold text-uppercase"><?php echo e(__('Slot Name')); ?></label>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="percentage" class="form-control" min="1" max="100" step="0.01" value="<?php echo e(old('percentage', $missingPercent > 0 ? $missingPercent : '')); ?>" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label text-muted smaller fw-bold text-uppercase"><?php echo e(__('Minutes')); ?></label>
                                        <input type="number" name="minutes" class="form-control" min="1" value="<?php echo e(old('minutes', $missingMinutes && $missingMinutes > 0 ? $missingMinutes : '')); ?>" required>
                                    </div>
                                    <div class="col-12 text-end">
                                        <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-soft">
                                            <?php echo e(__('Add Slot')); ?>
                ...
                <div id="taskSlotList" data-duration-minutes="<?php echo e($task->duration_minutes ?? ''); ?>" class="d-flex flex-column gap-3">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-5 rounded-4 bg-light border border-dashed" id="taskSlotEmpty">
                            ...
                            <p class="text-muted small italic"><?php echo e(__('No slots defined for this task')); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card h-100 shadow-sm border-light overflow-hidden" id="historyProgressCard">
            <div class="card-header border-bottom border-light p-4 d-flex align-items-center" style="background: #ffffff;">
                <h5 class="mb-0 text-dark fw-bold"><i class="mdi mdi-history me-2 text-warning"></i><?php echo e(__('Progress History')); ?></h5>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $slotHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="p-3 rounded-4 border border-light mb-3 hover-lift shadow-sm bg-white">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                             <div>
                                <div class="text-dark fw-bold small text-truncate" style="max-width: 15rem;"><?php echo e($slotName); ?></div>
                                <div class="smaller text-muted mt-1"><?php echo e($slotPercent); ?>% completed</div>
                             </div>
                             <span class="badge <?php echo e($statusClass); ?> rounded-pill" style="font-size: 0.6rem !important;">
                                <?php echo e(strtoupper($history->action)); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top border-light">
                            <div class="smaller text-muted d-flex align-items-center">
                                ...
                                <span class="text-truncate" style="max-width: 8rem;"><?php echo e($history->actor ? $history->actor->name : '-'); ?></span>
                            </div>
                            <button type="button" class="btn btn-link text-primary btn-sm p-0 smaller fw-bold history-detail-btn text-decoration-none shadow-none" data-bs-toggle="modal" data-bs-target="#historyDetailModal" data-details='<?php echo json_encode($detailPayload, 15, 512) ?>'>
                                <?php echo e(__('Details')); ?> <i class="mdi mdi-chevron-right"></i>
                            </button>
                        </div>
                        <?php if($history->action === 'rejected' && !empty($data['rejection_reason'])): ?>
                            <div class="mt-2 text-rose smaller border-start border-danger border-2 ps-2 italic" style="color: #e11d48;">"<?php echo e($data['rejection_reason']); ?>"</div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted smaller mb-0"><?php echo e(__('No entries in history.')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.appnew', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/tasks/show.blade.php ENDPATH**/ ?>