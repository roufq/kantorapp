  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row mb-4 align-items-center">
        <div class="col-lg-7">
          <h2 class="text-dark mb-1 fw-bold" style="font-size: 1.8rem; letter-spacing: -0.5px;"><?php echo e(__('Create Overtime Request')); ?></h2>
          <p class="text-muted mb-0" style="font-size: 1.05rem;"><?php echo e(__('Fill in the overtime request with clear duration and reason.')); ?></p>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('overtime.store')); ?>" method="POST">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-lg-6">
                                <div class="card shadow-sm border-0 p-4 rounded-4 border border-light h-100">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date" name="date" class="form-control rounded-pill px-4 shadow-sm" id="date" required value="<?php echo e(old('date', date('Y-m-d'))); ?>">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card shadow-sm border-0 p-4 rounded-4 border border-light h-100">
                                    ...
                                    <textarea name="reason" class="form-control mb-4" id="reason" rows="6" required placeholder="<?php echo e(__('Please explain why you need to work overtime...')); ?>" style="border-radius: 15px !important;"><?php echo e(old('reason')); ?></textarea>
                        ...
                        <div class="text-end mt-5 pt-4 border-top border-white border-opacity-5 d-flex gap-3 justify-content-end">
                            <a href="<?php echo e(route('overtime.index')); ?>" class="btn btn-outline-secondary rounded-pill px-4 fw-bold shadow-sm"><?php echo e(__('Cancel')); ?></a>
                            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-lg py-2" id="submitBtn" <?php if(!$isEmployee): ?> disabled <?php endif; ?>>
