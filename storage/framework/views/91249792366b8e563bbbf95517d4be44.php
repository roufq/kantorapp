...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('approval-rules.index')); ?>" class="btn btn-outline-secondary btn-sm">Kembali</a>
</div>
        ...
        <form method="POST" action="<?php echo e(route('approval-rules.update', $approval_rule)); ?>" class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="approval_level" class="form-select" required>
                    <option value="location_admin" <?php if(old('approval_level', $approval_rule->approval_level) === 'location_admin'): echo 'selected'; endif; ?>>Admin Lokasi</option>
            ...
            <div class="col-12">
                ...
                <a href="<?php echo e(route('approval-rules.index')); ?>" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
