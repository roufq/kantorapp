    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('overtime.show', $overtime)); ?>" class="btn btn-sm btn-secondary">Back to Detail</a>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('overtime.update', $overtime)); ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="date" class="form-control" id="date" value="<?php echo e(old('date', $overtime->date->format('Y-m-d'))); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="start_time" class="form-label">Start Time (WIB)</label>
                                <input type="time" name="start_time" class="form-control time-24" id="start_time" value="<?php echo e(old('start_time', $overtime->start_time_wib)); ?>" required step="60" pattern="[0-9]{2}:[0-9]{2}" lang="id-ID" inputmode="numeric" placeholder="HH:MM">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="time" name="end_time" class="form-control time-24" id="end_time" value="<?php echo e(old('end_time', $overtime->end_time_wib)); ?>" required step="60" pattern="[0-9]{2}:[0-9]{2}" lang="id-ID" inputmode="numeric" placeholder="HH:MM">
                                <small class="form-text text-muted">Format: HH:MM (24-jam)</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" class="form-control" id="reason" rows="4" required placeholder="Please explain why you need to work overtime..."><?php echo e(old('reason', $overtime->reason)); ?></textarea>
                    </div>
                    <?php if(isset($limits)): ?>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary" id="submitBtn" <?php if(!$isEmployee && count(old('selected_masters', $overtime->selected_masters ?? [])) === 0): ?> disabled <?php endif; ?>>Update Request</button>
                        <a href="<?php echo e(route('overtime.show', $overtime)); ?>" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>

                <hr class="my-4">

                <form action="<?php echo e(route('overtime.destroy', $overtime)); ?>" method="POST" onsubmit="return confirm('Cancel this overtime request?');">
                    <?php echo csrf_field(); ?>
