...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Manage Shifts for <?php echo e($location->name); ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Manage Shifts for <?php echo e($location->name); ?> (<?php echo e($location->code); ?>)</h3>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <form action="<?php echo e(route('location-shifts.update', $location)); ?>" method="POST">
                            ...
                            <div class="card-body">
                                <div class="alert alert-light border">
                                    ...
                                    <strong><?php echo e($location->name); ?></strong> (<?php echo e($location->code); ?>)<br>
                                    <small><?php echo e($location->address); ?></small>
                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                                        ...
                                                        <div class="d-flex gap-2 align-items-center">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="default_shift_id" id="default_<?php echo e($shift->id); ?>" value="<?php echo e($shift->id); ?>" <?php if(old('default_shift_id', $pivotDefaults[$shift->id] ?? false)): echo 'checked'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(route('location-shifts.show', $location)); ?>" class="btn btn-info float-right">
