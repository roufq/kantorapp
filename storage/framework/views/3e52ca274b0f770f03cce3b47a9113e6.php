            ...
            <div class="card-body">
                <form action="<?php echo e(route('tasks.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="slotList">
                        <div class="row g-2 mb-2 slot-row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="slots[0][name]" class="form-control" placeholder="Contoh: Desain UI" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Persentase (%)</label>
                                <input type="number" name="slots[0][percentage]" class="form-control" min="1" max="100" placeholder="25" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Menit</label>
                                <input type="number" name="slots[0][minutes]" class="form-control" min="1" placeholder="60" required>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="d-flex gap-2 mb-3">
                        ...
                        <span class="small text-muted ms-2">Minimal 1 slot. Total persentase harus 100%, total menit mengikuti durasi (jika diisi).</span>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\www\kantorapp\resources\views/tasks/create.blade.php ENDPATH**/ ?>