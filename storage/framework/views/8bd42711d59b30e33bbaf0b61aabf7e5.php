      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <p class="text-muted mt-2">Proses approval progres karyawan melalui halaman <a href="<?php echo e(route('tasks.progress.approvals')); ?>">Approval Progress</a>. Bukti progres dikirim via link.</p>
          </div>
        </div>
      </div>
    </div>
