...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    <div>
        <h3 class="mb-1">Employment Contracts</h3>
        <p class="text-muted mb-0">Employee contract history.</p>
    </div>
    <a href="<?php echo e(route('employee-contracts.create')); ?>" class="btn btn-primary btn-sm">Add Contract</a>
</div>
...
<div class="card">
    <div class="card-header"><h3 class="card-title">Contract List</h3></div>
        ...
        <table class="table table-hover text-nowrap">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="<?php echo e(route('employee-contracts.destroy', $contract)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Delete this contract?')">
                                <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="7" class="text-center text-muted">No contracts yet.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
