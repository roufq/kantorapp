...
<div class="bg-light p-3 mb-3 rounded border d-flex justify-content-between align-items-start flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('approval-rules.create')); ?>" class="btn btn-primary btn-sm">Tambah Rule</a>
</div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($rule->department ?? 'Semua'); ?></td>
                        <td><?php echo e($rule->min_value); ?></td>
                        <td><?php echo e($rule->approval_level === 'super_admin' ? 'Super Admin' : 'Admin Lokasi'); ?></td>
                        <td>
                        ...
                        <td>
                            ...
                            <form action="<?php echo e(route('approval-rules.destroy', $rule)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Hapus rule ini?')">
                                <?php echo csrf_field(); ?>
