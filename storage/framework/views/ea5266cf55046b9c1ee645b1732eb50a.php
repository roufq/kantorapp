    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('jobdesks.update', $jobdesk)); ?>" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="min_attendance_minutes" class="form-control" min="0" value="<?php echo e(old('min_attendance_minutes', $jobdesk->min_attendance_minutes)); ?>" placeholder="Example: 360 for 6 hours">
            </div>
