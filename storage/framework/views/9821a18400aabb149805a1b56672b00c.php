...
<script>
    ...
    function getLocation() {
        ...
        if (infoDiv) { 
            ...
            infoDiv.textContent = "<?php echo e(__('Requesting GPS Lock...')); ?>"; 
    ...
    function applyFix(position) {
        ...
        if (infoDiv) {
            ...
            if (acc > 80) { 
                ...
                infoDiv.textContent += " <?php echo e(__('Low accuracy, consider open space.')); ?>"; 
            } else { 
    ...
    function setupSelfieCapture(opts) {
        ...
        async function startCamera() {
            if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) { 
                alert("<?php echo e(__('Camera hardware not detected or browser unsupported.')); ?>"); 
                return; 
            }
            try {
                ...
                alert("<?php echo e(__('Access Denied: Please unlock camera permissions in your system settings.')); ?>");
            }
        }
        ...
        function captureSelfie() {
            ...
            if (byteSize > maxSelfieBytes) { alert("<?php echo e(__('Captured entity too dense. Please retry.')); ?>"); return; }
